    ...
    <div className="animate-slide-in">
      <div className="flex justify-between items-end mb-8">
        ...
        <button
          ...
          className="bg-primary text-on-primary px-6 py-2.5 rounded-lg font-bold flex items-center gap-2 hover:opacity-90 active:scale-95 transition-all"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-8">
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm flex items-center justify-between overflow-hidden relative">
          ...
          <div className="opacity-10 absolute -right-4 -bottom-4">
            <span className="material-symbols-outlined text-primary scale-[4]">
              group
            </span>
          </div>
        </div>
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm flex items-center justify-between overflow-hidden relative">
          ...
          <div className="opacity-10 absolute -right-4 -bottom-4">
            <span className="material-symbols-outlined text-tertiary scale-[4]">
              pending
            </span>
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-outline-variant bg-surface-container-low/50">
                ...
                <th className="px-6 py-4 text-label-md text-on-surface-variant uppercase tracking-wider text-right">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-outline-variant">
              {filtered.map((u) => (
                <tr
                  key={u.id}
                  className={`hover:bg-surface-bright transition-colors group ${u.status === "Pending" ? "bg-tertiary-container/5" : ""}`}
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-label-md font-bold ${
                        u.status === "Active"
                  ...
                  <td
                    className={`px-6 py-4 whitespace-nowrap text-body-md ${u.last_login ? "text-on-surface-variant" : "text-on-surface-variant italic"}`}
                  >
                    {u.last_login || "Never"}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-body-md text-on-surface-variant">
                    {u.created}
                  </td>
